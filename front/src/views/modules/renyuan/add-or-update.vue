<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="人员类型" prop="renyuanleixing">
          <el-input v-model="ruleForm.renyuanleixing" 
              placeholder="人员类型" clearable  :readonly="ro.renyuanleixing"></el-input>
        </el-form-item>
        <div v-else>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shouji = true;
          ...
          if(o=='renyuanleixing'){
            this.ruleForm.renyuanleixing = obj[o];
	    this.ro.renyuanleixing = true;
            continue;
          }
        }
      }
