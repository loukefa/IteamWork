  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.gongxubianhao" label="工序编号" prop="gongxubianhao">
              <el-input v-model="ruleForm.gongxubianhao" 
                placeholder="工序编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="设备名称" prop="shebeimingcheng">
          <el-select :disabled="ro.shebeimingcheng" v-model="ruleForm.shebeimingcheng" placeholder="请选择设备名称">
            <el-option
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="工序内容" prop="gongxuneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="工序内容"
                  v-model="ruleForm.gongxuneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.gongxuneirong" label="工序内容" prop="gongxuneirong">
                    <span>{{ruleForm.gongxuneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.picishuliang = true;
          ...
          if(o=='gongxuneirong'){
            this.ruleForm.gongxuneirong = obj[o];
	    this.ro.gongxuneirong = true;
            continue;
          }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shengchangongxu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shengchangongxuCrossAddOrUpdateFlag = false;
						 this.parent.search();
