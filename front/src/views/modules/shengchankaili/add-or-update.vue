<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工单数量" prop="gongdanshuliang">
          <el-input v-model="ruleForm.gongdanshuliang" 
              placeholder="工单数量" clearable  :readonly="ro.gongdanshuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工单数量" prop="gongdanshuliang">
              <el-input v-model="ruleForm.gongdanshuliang" 
                placeholder="工单数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="批次说明" prop="picishuoming">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="批次说明"
                  v-model="ruleForm.picishuoming" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.picishuoming" label="批次说明" prop="picishuoming">
                    <span>{{ruleForm.picishuoming}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='gongdanshuliang'){
            this.ruleForm.gongdanshuliang = obj[o];
	    this.ro.gongdanshuliang = true;
            continue;
          }
          if(o=='shengchanpici'){
	    ...
	    this.ro.picishuliang = true;
          ...
          if(o=='picishuoming'){
            this.ruleForm.picishuoming = obj[o];
	    this.ro.picishuoming = true;
            continue;
          }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `shengchankaili/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.shengchankailiCrossAddOrUpdateFlag = false;
						 this.parent.search();
